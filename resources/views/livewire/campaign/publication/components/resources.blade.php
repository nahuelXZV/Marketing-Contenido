...
<div class="flex  w-full flex-wrap justify-center p-5 ">
    <div class="w-full mb-4">
        <h2 class="text-lg font-bold text-start dark:text-white">
            Selecciona la imagen que deseas agregar a la publicacion
        </h2>
    </div>
    <div class="grid grid-cols-4 gap-3">
        @foreach ($resources as $resource)
            <div class="w-auto bg-white p-1 dark:bg-gray-800 dark:text-white">
                ...
                <ul class="mt-3 flex flex-wrap">
                    <li class="mr-auto">
                        <a class="flex text-gray-400 hover:text-gray-600 dark:text-white"
                    ...
                    <li>
                        <button class="flex text-gray-400 hover:text-gray-600 dark:text-white"
                            wire:loading.attr="disabled" wire:click="selectedResource({{ $resource->id }})">
                            @if ($resource->selected == true)
                                <svg class="mr-0.5 text-red-900 dark:text-red-500" style="width:24px;height:24px" viewBox="0 0 24 24">
